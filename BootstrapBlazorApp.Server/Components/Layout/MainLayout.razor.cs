...
public sealed partial class MainLayout
{
    ...
    private static List<MenuItem> GetIconSideMenuItems()
    {
        var menus = new List<MenuItem>
        {
            ...
            new() { Text = "DynamicTable", Icon = "fa-solid fa-fw fa-table", Url = "/dynamic" },
            new() { Text = "TreeTable", Icon = "fa-solid fa-fw fa-table", Url = "/tree" },
            new() { Text = "DockView", Icon = "fa-solid fa-fw fa-table", Url = "/dock" },
